...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <button type="button" onClick={() => setSelection("blogForm")}>
          Blog Form
        </button>
        <button type="button" onClick={() => setSelection("contactForm")}>
          Contact Form
        </button>
        <button type="button" onClick={() => setSelection("blogReading")}>
          Blog Reading App
        </button>
        <button type="button" onClick={() => setSelection("bookmarking")}>
          Bookmarking App
        </button>
        <button type="button" onClick={() => setSelection("blogApp")}>
          {" "}
          Blog App
        </button>
      </header>
